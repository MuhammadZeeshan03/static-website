...
Next when i run the commad i faced issue that docker daemon is not working well. So, i came to know that docker is not running. i opened the docker and it started working.
